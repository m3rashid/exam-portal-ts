          ...
          <Col offset={2} span={22}>
            <Transfer
              filterOption={(inputValue, option) =>
                option.difficulty.indexOf(inputValue) > -1 ||
                option.level.indexOf(inputValue) > -1 ||
                option.school.indexOf(inputValue) > -1 ||
                option.year.indexOf(inputValue) > -1 ||
                option.component.indexOf(inputValue) > -1 ||
                option.exam.indexOf(inputValue) > -1 ||
                option.topic.indexOf(inputValue) > -1 
              }
              showSearch
