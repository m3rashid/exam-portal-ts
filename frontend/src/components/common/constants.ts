...
export const givenComponents = [
  { label: 'Paper 1 Booklet A', value: 'Paper 1 Booklet A' },
  { label: 'Paper 1 Booklet B', value: 'Paper 1 Booklet B' },
...
export const givenScienceTopics = [
  ...
  { label: 'Water and chnages in State', value: 'Water and changes in State' },
